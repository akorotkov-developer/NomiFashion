...
$userConsent = COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_BUY1CLICK", "N", SITE_ID);
$userConsentId = intval(COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_BUY1CLICK_ID", "", SITE_ID));
