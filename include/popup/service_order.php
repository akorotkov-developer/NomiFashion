<?if (CModule::IncludeModule('bitlate.apparelshop')) {
    $message = COption::GetOptionString("bitlate.apparelshop", "NL_SERVICE_ORDER_OKKADD_MESS", "", SITE_ID);
    $email = COption::GetOptionString("bitlate.apparelshop", 'NL_SERVICE_ORDER_EMAIL', '#DEFAULT_EMAIL_FROM#', SITE_ID);
