...
define('IBLOCK_ID_CATALOG', '4');
define('IBLOCK_ID_OFFERS', '5');
define('IBLOCK_ID_BANNERS', '6');
define('IBLOCK_ID_MAIN_SLIDER', '6');
define('IBLOCK_ID_NEWS', '3');
define('IBLOCK_ID_ACTIONS', '7');

define('SITE_PHONE', '8 (495) 151 82 01');
