                    ...
                    <div class="main-product-tabs">
                        <div class="advanced-container-medium">
                            ...
                            <ul class="tabs inline-block-container text-center show-for-large" id="main-product-tabs" data-tabs>
                                <li class="tabs-title inline-block-item float-none is-active"><a href="#product-tab-news"><span><?=getMessage('TITLE_TAB_NEWS')?></span></a></li>
                                <li class="tabs-title inline-block-item float-none"><a href="#product-tab-recomend"><span><?=getMessage('TITLE_TAB_RECOMEND')?></span></a></li>
                        ...
                        <div class="container row tabs-content" data-tabs-content="main-product-tabs">
                            ...
                            foreach ($arTabs as $type):?>
                                <div class="tabs-panel<?if ($type == 'news'):?> is-active<?endif;?>" id="product-tab-<?=$type?>">
