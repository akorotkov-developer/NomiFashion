...
$userConsent = COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_LOGIN", "N", SITE_ID);
$userConsentId = intval(COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_LOGIN_ID", "", SITE_ID));
                ...
                <fieldset class="block-main-user-consent-request checkbox-accept column">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "INPUT_NAME" => "auth_authorize_user_consent",
                            "REPLACE" => array(
                                "button_caption" => GetMessage("AUTH_AUTHORIZE"),
                                "fields" => array(GetMessage("AUTH_LOGIN"), GetMessage("AUTH_PASSWORD")),
                            ),
                        ),
                        false
                    );?>
