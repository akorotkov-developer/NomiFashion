...
$formWidth = (isset($_REQUEST["formWidth"]) && intval($_REQUEST["formWidth"]) > 0) ? (intval($_REQUEST["formWidth"]) / 2) : 400;
$formWidth = ($formWidth < 250) ? 250 : $formWidth;
?>
<html>
<head>
