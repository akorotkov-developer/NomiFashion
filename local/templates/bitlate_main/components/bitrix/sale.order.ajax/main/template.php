...
<div class="bx_order_make">
	...
	else
	{
		...
		else
		{
            ...
            $userConsent = COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_ORDER", "N", SITE_ID);
            $userConsentId = intval(COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_ORDER_ID", "", SITE_ID));
                    ...
                    <fieldset class="block-main-user-consent-request checkbox-accept column">
                        <?$APPLICATION->IncludeComponent(
                            ...
                            array(
                                ...
                                "REPLACE" => array(
                                    'button_caption' => GetMessage("SOA_TEMPL_PAYMENT_BUTTON"),
