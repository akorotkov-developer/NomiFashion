    ...
    <?endif;?>
        <div class="item column text-center hover-elements"<?if ($arParams["TEMPLATE_THEME"] == 'slider'):?> id="<? echo $strMainID; ?>"<?endif;?>>
            ...
            <div class="hover-show bx_catalog_item_controls">
                ...
                <?if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) {?>
                    <?if ($discount > 0 && 'Y' == $arParams['SHOW_OLD_PRICE'] && (!$isPriceMulty || count($arItem['PRICES']) <= 1) && !(in_array('prodday', $itemType) && $discount > 0 && $arParams['TAB_TYPE']) && !(in_array('action', $itemType) && $arParams['TAB_TYPE'])):?>
                ...
                <?} else {?>
                    <?if ('Y' == $arParams['SHOW_OLD_PRICE'] && (!$isPriceMulty || count($arItem['PRICES']) <= 1) && !((in_array('action', $itemType) || in_array('prodday', $itemType)) && $arParams['TAB_TYPE'])):?>
