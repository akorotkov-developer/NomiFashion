...
$countCompareCaptionMini = '0 ' . NLApparelshopUtils::nl_inclination(0, GetMessage('NL_PRODUCT_1'), GetMessage('NL_PRODUCT_2'), GetMessage('NL_PRODUCT_10'));
$countCompareCaption = $countCompareCaptionMini . ' ' . GetMessage('COMPARE_CAPTION');
$template = NLApparelshopUtils::getComponentTemplate("compare");
?>
