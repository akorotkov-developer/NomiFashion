...
$arTemplateParameters['PAGE_ELEMENT_COUNTS'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('PAGE_ELEMENT_COUNTS'),
	'TYPE' => 'STRING',
	"MULTIPLE" => "Y",
);
$arTemplateParameters['SORT_LIST_CODES'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SORT_LIST_CODES'),
	'TYPE' => 'STRING',
	"MULTIPLE" => "Y",
);
$arTemplateParameters['SORT_LIST_FIELDS'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SORT_LIST_FIELDS'),
	'TYPE' => 'STRING',
	"MULTIPLE" => "Y",
);
$arTemplateParameters['SORT_LIST_ORDERS'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SORT_LIST_ORDERS'),
	'TYPE' => 'STRING',
	"MULTIPLE" => "Y",
);
$arTemplateParameters['SORT_LIST_NAME'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('SORT_LIST_NAME'),
	'TYPE' => 'STRING',
	"MULTIPLE" => "Y",
);
$arTemplateParameters['CATALOG_MAIN_LIST'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('CPT_CATALOG_MAIN_LIST'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y',
	'SORT' => 800
);
$arTemplateParameters['FILTER_NUMBERS_SHOW'] = array(
	'PARENT' => 'FILTER_SETTINGS',
	'NAME' => GetMessage('CPT_FILTER_NUMBERS_SHOW'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y',
	'SORT' => 800
);
$arTemplateParameters['SHOW_PRODUCT_SET'] = array(
	'PARENT' => 'VISUAL',
	'NAME' => GetMessage('CPT_SHOW_PRODUCT_SET'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'N',
	'SORT' => 900
);
$arTemplateParameters['MESS_GENERAL_STORE'] = array(
	'PARENT' => 'STORE_SETTINGS',
	'NAME' => GetMessage('CPT_MESS_GENERAL_STORE'),
	'TYPE' => 'STRING',
	'SORT' => 100
);
?>