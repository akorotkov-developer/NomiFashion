...
$MESS["PAGE_ELEMENT_COUNTS"] = "Показывать по (ALL - показать все)";
$MESS["SORT_LIST_CODES"] = "Код сортировки в урл";
$MESS["SORT_LIST_FIELDS"] = "Коды полей (разделяются ; если сортировка по двум полям)";
$MESS["SORT_LIST_ORDERS"] = "Направление сортировки (разделяются ; если сортировка по двум полям)";
$MESS["SORT_LIST_NAME"] = "Название сортировки";
$MESS["CPT_CATALOG_MAIN_LIST"] = "Показывать при входе в каталог список разделов";
$MESS["CPT_FILTER_NUMBERS_SHOW"] = "Выводить в диапазонах минимальное и максимальное значение";
$MESS["CPT_SHOW_PRODUCT_SET"] = "Показывать состав комплекта";
$MESS["CPT_MESS_GENERAL_STORE"] = "Подпись для вывода \"Общего остатка на складах\"";
?>