            ...
            <ul class="main-plus-container inline-block-container">
                <?foreach($arResult["ITEMS"] as $k => $arItem):
                    ...
                    if (intval($arItem["PREVIEW_PICTURE"])) {
                        $pic = NLApparelshopUtils::getResizeImg($arItem["PREVIEW_PICTURE"], array('width' => 200, 'height' => 115), BX_RESIZE_IMAGE_EXACT);
                    }?>
                    <?
                    ...
                    <li class="main-plus-item inline-block-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                        ...
                        <?endif;?>
                        <div class="main-plus-text sdfsdfs"><?echo $arItem["~PREVIEW_TEXT"];?></div>
                    </li>
                <?endforeach;?>
            </ul>
        </div>
