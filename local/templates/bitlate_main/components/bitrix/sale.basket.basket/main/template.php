...
$showOldPrice = (Option::get('bitlate.apparelshop', "NL_CATALOG_SHOW_OLD_PRICE", "N", SITE_ID) == "Y") ? true : false;
CModule::IncludeModule('bitlate.apparelshop');
...
$offersParams = array();
$offersCartProps = COption::GetOptionString("bitlate.apparelshop", 'NL_CATALOG_CART_OFFERS_PROPERTY_CODE', false, SITE_ID);
