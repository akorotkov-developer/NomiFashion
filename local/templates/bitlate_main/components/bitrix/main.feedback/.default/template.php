...
$userConsent = COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_FEEDBACK", "N", SITE_ID);
$userConsentId = intval(COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_FEEDBACK_ID", "", SITE_ID));
