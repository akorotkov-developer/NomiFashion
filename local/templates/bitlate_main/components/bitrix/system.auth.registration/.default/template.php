...
<div id="registration<?if ($isStatic):?>-static<?endif;?>" class="fancybox-block">
    ...
    <div class="fancybox-block-wrap fancybox-block-wrap-order">
        ...
        <?$fields = array(GetMessage("AUTH_NAME"), GetMessage("AUTH_LOGIN_MIN"), GetMessage("AUTH_PASSWORD_REQ"));?>
        <?if($arResult["USE_EMAIL_CONFIRMATION"] === "Y" && is_array($arParams["AUTH_RESULT"]) &&  $arParams["AUTH_RESULT"]["TYPE"] === "OK"):?>
            ...
            <fieldset class="together">
                ...
                <?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
                    ...
                    <?foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField):
                        $fields[] = $arUserField["EDIT_FORM_LABEL"];?>
                ...
                <fieldset class="block-main-user-consent-request checkbox-accept column">
                    <?$APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "INPUT_NAME" => 'auth_registration_user_consent',
                            "REPLACE" => array(
                                'button_caption' => GetMessage("AUTH_REGISTER_BUTTON"),
                                'fields' => $fields,
                            ),
                        )
                    );?>
