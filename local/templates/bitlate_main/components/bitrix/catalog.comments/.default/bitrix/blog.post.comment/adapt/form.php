...
$userConsent = COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_REVIEW", "N", SITE_ID);
$userConsentId = intval(COption::GetOptionString("bitlate.apparelshop", "NL_USER_CONSENT_REVIEW_ID", "", SITE_ID));
    ...
    <div id="new-comment" class="fancybox-block">
        ...
        <div class="fancybox-block-wrap">
            <form action="<?=$_SERVER['REQUEST_URI']?>" class="form" id="form-review" method="post" enctype="multipart/form-data">
                ...
                <?endif;?>
                <?if ($userConsent == "Y" && $userConsentId > 0 && empty($arResult["User"])):?>
                    <fieldset class="block-main-user-consent-request checkbox-accept column">
                        <?$APPLICATION->IncludeComponent(
                            ...
                            array(
                                ...
                                "INPUT_NAME" => 'review_user_consent',
                                "REPLACE" => array(
                                    'button_caption' => GetMessage("BUTTON_SEND"),
                                    'fields' => array(GetMessage("BLOG_USER_NAME"))
                                ),
                            )
                        );?>
                    </fieldset>
